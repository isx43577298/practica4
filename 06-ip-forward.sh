...
iptables -A FORWARD -s 172.19.0.0/16 -o enp6s0 -p tcp --dport 80 -j ACCEPT
iptables -A FORWARD -d 172.19.0.0/16 -p tcp --sport 80 -i enp6s0 -m state --state RELATED,ESTABLISHED -j ACCEPT
...
iptables -A FORWARD -s 172.19.0.0/16 -d 172.20.0.0/16 -p tcp --dport 2013 -o enp6s0 -j REJECT
iptables -A FORWARD -s 172.19.0.0/16 -p tcp --dport 2013 -o enp6s0  -j ACCEPT
# evitar que es falsifiqui la ip de origen: SPOOFING
iptable -A FORWARD  ! -s 172.19.0.0/16 -i br-7d521247ea41 -j DROP
